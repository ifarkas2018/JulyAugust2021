    ...
    <body class="sivapoz"> <!-- sivapoz - klasa koja postavlja sivu pozadinu (css_pravila.css) -->
        <div class="container">
            ...
            <%
            	...
            	Object indexObj1 = hSesija1.getAttribute("indeks_knjige"); // @@@@@@@@@@@@@@@ BEGIN of DELETE
            	int index1 = 0;
            	if (indexObj1 != null ){ // ADDED
            		index1 = Integer.parseInt(String.valueOf(indexObj1));
                	// index1 = 2;
            	} else {
            		index1 = 1;
           		}
            	out.println("index1=" + index1);
            	hSesija1.setAttribute("indeks_knjige", index1); // @@@@@@@@@@@@@@@ END of DELETE

...
<html>
    <head>
        ...
        <script>
            <!-- ~~~~~~~~~HERE WAS the function obrisiKolacic I copied to the ptica_knjiga_OSTATAK.tag -->
        </script>
    </head>
    ...
    <body> 
        ...
        <%
        	...
        	Integer index = 0;
        	// @@ String strIndex = ""; // @@@@@@@@@@@ DELETE THIS
        	Object indexObj = hSesija.getAttribute("indeks_knjige"); // ONLINE: this one and the NEXT was not commented out the rest of them were
        	if (indexObj != null ){ 
        		index = Integer.parseInt(String.valueOf(indexObj)); // @@@@@@@@ put this into try catch block
        		// @@ strIndex = String.valueOf(indexObj);
            	// @@ index = 2;
        	} else {
        		// @@ strIndex = "Prazan String";
        		index = 1;
        	}
        	out.println("index=" + index);
        	// @@ out.println("strIndex=" + strIndex);
            ...
            // @@ index = 1; // ADDED
            // boolean postoji_varses = false; // ADDED
            
            /*
            boolean postoji_varses = PticaMetodi.varSesijePostoji(hSesija, "indeks_knjige");
            if (postoji_varses == true) {
            	postoji_varses = false;
            } else {
            	postoji_varses = true;
            }
            */
